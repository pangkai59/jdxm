...
public class QRCodeFactory {
     ...
     * @param outFileUri 生成二维码文件路径
     * @param logUri     二维码中间logo的地址
     * @param size       用于设定图片大小（可变参数，宽，高）
     * @throws IOException     抛出io异常
     * @throws WriterException 抛出书写异常
     */
    public File creatQrImageToFile(String content, String format, String outFileUri, String logUri, int... size) throws IOException, WriterException {
        ...
        MatrixToImageWriter.writeToFile(bitMatrix, format, file, logUri);

        return file;
    }


    public void creatQrImageToStream(String content, String format, OutputStream outputStream, String logUri, int... size) throws IOException, WriterException {
        ...
        MatrixToImageWriter.writeToStream(bitMatrix, format, outputStream, logUri);
    }
